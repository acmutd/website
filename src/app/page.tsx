...
function Home() {
  const sponsors = ['americanairlines', 'goldmansachs', 'statefarm', 'capitalone', 'eogresources', 'paycom'];
  ...
  return (
    <main className="flex h-screen flex-col gap-y-56 bg-[url(/assets/apply/apply-bg.png)] bg-cover pt-24 text-white">
      <div className="flex flex-row gap-x-11">
        <div className="flex max-w-xl flex-col gap-y-4 rounded-r-2xl border-y border-r border-primary/50 bg-gray-300/10 p-14">
          <h1 className="text-6xl font-semibold">association of computing machinery</h1>
          <p>
          ...
          <div>Community icons (todo)</div>
        </div>
        <div className="mt-12 flex flex-col gap-y-10">
          <div className="flex max-w-xs flex-col items-start rounded-2xl border-primary/50 bg-gray-300/10 py-6 pl-28 pr-3">
            <p>join our mailing list to stay updated with our events and programs!</p>
          ...
          <div className="flex max-w-xs flex-col items-start rounded-2xl border-primary/50 bg-gray-300/10 py-6 pl-28 pr-3">
            <p>acm applications now open for fall 2023!</p>
            <div className="mt-2 self-end">
              <Link
                href="/"
                className="flex h-[2.30rem] w-fit items-center justify-center bg-acm-gradient px-4 py-2 text-base font-bold md:text-xl"
