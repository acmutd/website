  ...
  return (
    <div className="mx-7 my-4 text-center">
      <div className="flex flex-row items-center gap-x-4">
        ...
        <div className="h-fit w-full text-center align-middle">
          <div className="text-5xl font-semibold text-primary">
            we&apos;re just a group of people
          </div>
          <div className="relative mt-4 rounded-3xl bg-opacity-10 bg-gradient-to-br p-8 text-primary backdrop-blur-md">
