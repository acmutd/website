...
export function FlexCarousel({ items }: FlexCarouselProps) {
  ...
  return (
    <div className="background-container relative mx-12 md:mx-3 lg:mx-auto flex w-full lg:max-w-[50vw] flex-col gap-y-6 rounded-3xl border border-primary/50 bg-amber-600/10 p-3 pb-8 backdrop-blur-xl">
