...
export const industryFAQ: Question[] = [
  ...
  },
  {
    ...
    answer: 'Applications open on a rolling basis — be sure to watch our Discord and Instagram for announcements regarding industry coordinator positions! We look for people who have a knack for professionalism and connection along with a determination to connect the professional and student world.'
  },
  {
